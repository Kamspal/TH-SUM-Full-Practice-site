...
<section id="blog1" style="height: 24650px">
    <div class="container1">
        ...
        <div class="right2">
            ...
            <div class="previous_post top12">
                    <a href="news/page2">« Older Entries</a>
                </div>
                <div class="post post_margin">
                <div class="bloghead">
                    Nov 7/14
                </div>
                    <div class="btitle">
                        <a href="/blog/bc-sports-hall-of-fame">BC Sports Hall of Fame: 1954 British Empire and Commonwealth Games</a>
                    </div>
                        <div class="entry">
                            <p>
                            ...
                            <h5 class="data">
                                Posted by val | Posted in <a href="/blog/category/news">News</a>
                            </h5>
            </div>
            <div class="post post2">
                        <div class="bloghead">
                            ...
                            <div class="btitle">
                                <a href="/blog/flight-path-park">Larry Berg – Flight Path Park</a>
                            </div>
                                <div class="entry">
                                    <p>
                                    ...
                                    <p>
                                    To learn more about this project, check out this article at 
                                        <a href="">vancitybuzz.com</a>
                                    </p>
                                    <p>
                                    ...
                                    <h5 class="data">
                                        Posted by val | Posted in <a href="/blog/category/news">News</a>,
                                    <a href="/blog/category/projects">Projects</a>
                                    </h5>
                    </div>
                    <div class="post post5 post_top">
                    <div class="bloghead">
                        Jul 13/12
                    </div>
                        <div class="btitle">
                            <a href="/blog/latest-gifts">Latest gifts from Quarterly.co</a>
                        </div>
                            <div class="entry">
                                <p>
                                A short while ago we discovered
                                <a href="">Quarterly.co</a>
                                — a website where you can subscribe to your favorite design heroes and receive themed, mystery gifts mailed to you every 3 months. We started off with Tina Roth Eisenberg (Swiss Miss) and Josh Rubin & Evan Orensten (Cool Hunting). Here’s what we’ve received so far:
                                    <br>
                                    <br>
                                    <br>
                                </p>
                                ...
                                <h5 class="data">
                                    Posted by val | Posted in <a href="/blog/category/news">News</a>,
                                    <a href="/blog/category/stuff_we_like">Stuff We Like</a>
                                </h5>
                </div>
                <div class="post post6">
                    <div class="bloghead">
                        ...
                        <div class="btitle">
                            <a href="/blog/icebreaker-merino-wool">Icebreaker Merino Wool: Staff Retail Site</a>
                        </div>
                            <div class="entry">
                                <p>
                ...
                <div class="post post7">
                    <div class="bloghead">
                        ...
                        <div class="btitle">
                            <a href="/blog/spencer-welch-vocal-studio">Spencer Welch Vocal Studio Gets a Fresh, New Look</a>
                        </div>
                            <div class="entry">
                                <p>
                ...
                <div class="post post8">
                    <div class="bloghead">
                        ...
                        <div class="btitle">
                            <a href="/blog/dans-plan">Dan’s Plan: Custom Web Illustrations</a>
                        </div>
                            <div class="entry">
                                <p>
                                Dan’s Plan focuses on helping people achieve a lifestyle that promotes optimal health in today’s modern environment. TH= SUM created simple and engaging illustrations to help users understand the key objectives of Dan’s Plan. They focus on food, movement, and sleep to help achieve and sustain your ideal weight. 
                ...
                <div class="post post9">
                    <div class="bloghead">
                        ...
                        <div class="btitle">
                            <a href="/blog/sonic-tonic">Sonic Tonic</a>
                        </div>
                            <div class="entry">
                                <p>
                ...
                <div class="post post10 post_top1">
                <div class="bloghead">
                    Aug 23/11
                </div>
                    <div class="btitle">
                        <a href="/blog/vancouver-is-awesome">Vancouver Is Awesome: Interview with Chris Wong</a>
                    </div>
                        <div class="entry">
                            <p>
                            TH= SUM was super stoked to hear that Vancouver Is Awesome wanted an interview with our very talented Creative Director, Chris Wong. To read it, 
                            <a href="">Click here</a>
                            </p>
                            <p>
            ...
            <div class="post post11">
                <div class="bloghead">
                    ...
                    <div class="btitle">
                        <a href="/blog/san-francisco-aquarium">San Francisco Aquarium of the Bay</a>
                    </div>
                        <div class="entry">
                            <p>
                            The new website for the San Francisco Aquarium of the Bay is up! 
                            <a href="">Click here</a>
                            to check it out.
                            </p>
                            <p>
                            TH= SUM had the pleasure of working with 
                                <a href="">The Spider</a>
                                to help develop the creative direction for the aquarium’s new website. Our challenge was to update the design of the website in a family-friendly way while retaining key design elements from their previous website. Large amounts of content were organized in a way that showed a clear hierarchy and directed user experience.
                            </p>
                            <p>
            ...
            <div class="post post12">
                <div class="bloghead">
                    ...
                    <div class="btitle">
                        <a href="/blog/water-everywhere">Water water everywhere…</a>
                    </div>
                        <div class="entry">
                            <p>
            ...
            <div class="previous_post pre_top">
                    <a href="news/page2">« Older Entries</a>
                </div>
        </div>
</section>
